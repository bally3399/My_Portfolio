...
export default function Portfolio() {
  ...
  return (
      <div className="min-h-screen bgblack text-white">
        <header className="header">
          <h1 className="logo">Bimbim</h1>
            {/*<a href="/api/cv" target="_blank" rel="noopener noreferrer" className="cv-button">*/}
            {/*    View CV*/}
                      ...
                      <div className="hero-content">
                          <div className="hero-text">
                              ...
                              <p className="hero-description">
                                  I'm a software engineer based in Lagos, Nigeria, skilled in frontend and backend
                                  development. I build
                          ...
                          <div className="hero-stats">
                              <div>
                                  <p className="stat-text">
                                      Highly skilled at progressive enhancement, modern web technologies & full-stack
                                      development.
                                  </p>
                              </div>
                              <div>
            ...
            <section id="contact" className="contact-section">
              <div className="contact-container">
                ...
                <div className="contact-buttons">
                  ...
                  <a href="https://www.linkedin.com/in/baliqis-sulaiman/" className="contact-btn secondary">
